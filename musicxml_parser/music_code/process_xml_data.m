...
if (~(exist('DATAPATH','var')))
    DATAPATH = 'D:\Documents\Uni\2018\App Prob\Group Project\Song Data\Input'%'../../Song Data/Input';
end
...
DISCARD_CHORDLESS_SONGS = 0;

% Set up the output file, where we'll write the output structures
if (~exist('MATLAB_OUTPUT_FILE'))
    MATLAB_OUTPUT_FILE= 'D:\Documents\Uni\2018\App Prob\Group Project\Song Data\Output';
end
...
pushd = pwd;
cd('D:\Documents\Uni\2018\App Prob\Group Project\Song Data\Output');
write_text_data;
cd(pushd);
